...
public class AliyunOSSUtils {
    ...
    log.info("credentialsProvider+>"+credentialsProvider);
        ...
        try {
            ...
            PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName, "practice/emp/"+objectName, new ByteArrayInputStream(content));
            // 创建PutObject请求。
        ...
        String url = endpoint.split("//")[0] + "//" + bucketName + "." + endpoint.split("//")[1] + "/" + "practice/emp/" + objectName;
        log.info(url);
        return url;
    }
